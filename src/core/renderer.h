...
public:
    ...
    bool render(Scene& scene, const uint32_t x, const uint32_t y) const;
    bool render(SceneGPU& scene, const std::string& output="./test.jpg") const;
    bool render(SceneGPU& scene, const uint32_t x, const uint32_t y) const;
