...
public:
    ...
    virtual RGBSpectrum sample(const Intersection& isect, float& pdf, const HitablePtr scene) const = 0;
    virtual float       pdf(const Intersection& isect) const {
        return 1.f;
    }
    virtual RGBSpectrum eval(const Intersection& isect) const = 0;
...
public:
    ...
    RGBSpectrum sample(const Intersection& isect, float& pdf, const HitablePtr scene) const override;
    RGBSpectrum eval(const Intersection& isect, const Vec3f& n) const override;
